...
public class PlatformGridView extends LinearLayout implements
	...
	private Platform[] platformList = {
			ShareSDK.getPlatform(getContext(), "QQ"),
			ShareSDK.getPlatform(getContext(), "QZone"),
			ShareSDK.getPlatform(getContext(), "TencentWeibo"),
			ShareSDK.getPlatform(getContext(), "Wechat"),
			ShareSDK.getPlatform(getContext(), "WechatMoments"),
			ShareSDK.getPlatform(getContext(), "Email"),
			ShareSDK.getPlatform(getContext(), "ShortMessage"),
			ShareSDK.getPlatform(getContext(), "SinaWeibo"),
			ShareSDK.getPlatform(getContext(), "Facebook"),
			ShareSDK.getPlatform(getContext(), "SohuSuishenkan"),
			ShareSDK.getPlatform(getContext(), "Twitter"),
			ShareSDK.getPlatform(getContext(), "NetEaseMicroBlog"),
			ShareSDK.getPlatform(getContext(), "YouDao")};
	...
	private void init(final Context context) {
		...
		pager.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,
