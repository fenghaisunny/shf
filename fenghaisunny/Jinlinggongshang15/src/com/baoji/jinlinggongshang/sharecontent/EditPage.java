...
public class EditPage extends FakeActivity implements OnClickListener, TextWatcher, Callback {
	...
	private void initPageView() {
		...
		llTitle.getTvTitle().setTextColor(this.getContext().getResources().getColor(android.R.color.black));
		llTitle.getBtnRight().setVisibility(View.VISIBLE);
		llTitle.getBtnRight().setText(R.string.share);
		llTitle.getBtnRight().setTextColor(this.getContext().getResources().getColor(android.R.color.black));
	...
	public void onClick(View v) {
		...
		if (v.equals(llTitle.getBtnBack())) {
			...
			this.finish();
			this.activity.overridePendingTransition(R.anim.push_right_in,
