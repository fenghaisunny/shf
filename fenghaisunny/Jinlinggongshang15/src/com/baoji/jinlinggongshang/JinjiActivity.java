...
public class JinjiActivity extends MugongActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageUrl = "http://192.168.2.6:8080/JsonWeb01/images/jinjidec.png";
		ImageLoaderUtils.imageLoader.displayImage(imageUrl, diangudec_image, ImageLoaderUtils.options);
		diangudec_tv.setText(getString(R.string.jinjidec));
	}
