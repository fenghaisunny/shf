...
import com.baoji.jinlinggongshang.util.LightControl;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ImageButton cate = (ImageButton) findViewById(R.id.category);
		cate.setVisibility(View.GONE);

		btn_light_control = (Button) findViewById(R.id.btn_light_control);
