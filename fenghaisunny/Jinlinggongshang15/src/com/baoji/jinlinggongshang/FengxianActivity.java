...
public class FengxianActivity extends FamensiActivity {
	...
	class MyOnClickListener7 implements OnClickListener {
		...
		public void onClick(View v) {
			...
			switch (v.getId()) {
			case R.id.yule:
				Toast.makeText(FengxianActivity.this, "你点了娱乐7！", Toast.LENGTH_SHORT).show();
				break;
			case R.id.lvyouluxian:
				Toast.makeText(FengxianActivity.this, "你点了路线7！", Toast.LENGTH_SHORT).show();
				break;
			case R.id.meishicanyin:
				Toast.makeText(FengxianActivity.this, "你点了餐饮7！", Toast.LENGTH_SHORT).show();
				break;
			case R.id.location:
				Intent callMap = new Intent(FengxianActivity.this,TransportationActivity.class);
				callMap.putExtra("callMap", true);
				callMap.putExtra("result", "凤县");
