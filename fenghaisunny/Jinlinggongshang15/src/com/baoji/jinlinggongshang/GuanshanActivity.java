...
public class GuanshanActivity extends FamensiActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		yule.setOnClickListener(new MyOnClickListener8());
		luxian.setOnClickListener(new MyOnClickListener8());
		canyin.setOnClickListener(new MyOnClickListener8());
		location.setOnClickListener(new MyOnClickListener8());
	...
	class MyOnClickListener8 implements OnClickListener {
		...
		public void onClick(View v) {
			...
			switch (v.getId()) {
			case R.id.yule:
				Toast.makeText(GuanshanActivity.this, "你点了娱乐6！", Toast.LENGTH_SHORT).show();
				break;
			case R.id.lvyouluxian:
				Toast.makeText(GuanshanActivity.this, "你点了路线6！", Toast.LENGTH_SHORT).show();
				break;
			case R.id.meishicanyin:
				Toast.makeText(GuanshanActivity.this, "你点了餐饮6！", Toast.LENGTH_SHORT).show();
				break;
			case R.id.location:
				Intent callMap = new Intent(GuanshanActivity.this,TransportationActivity.class);
				callMap.putExtra("callMap", true);
				callMap.putExtra("result", "关山牧场");
				GuanshanActivity.this.startActivity(callMap);
