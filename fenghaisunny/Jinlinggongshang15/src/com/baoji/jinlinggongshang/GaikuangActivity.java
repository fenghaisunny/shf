...
public class GaikuangActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gaikuang);
		...
		gaikuangpic = (ImageView)findViewById(R.id.gaikuangpic);
		
		ImageLoaderUtils.imageLoader.displayImage("http://192.168.2.6:8080/JsonWeb01/images/baojiyoulai.png", gaikuangpic, ImageLoaderUtils.options);
	...
	public void onClick(View v) {
		...
		case R.id.twodimen_sli:
			...
			Intent twodimen = new Intent(GaikuangActivity.this,
