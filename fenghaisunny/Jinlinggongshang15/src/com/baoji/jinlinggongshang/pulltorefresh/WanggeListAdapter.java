...
public class WanggeListAdapter extends BaseAdapter {

	public static ImageView img2;
	private List<TableItem> lists;
	private Context context;

	public WanggeListAdapter(Context context, List<TableItem> lists) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView != null) {
			...
			view = LayoutInflater.from(context).inflate(R.layout.wangge_listitem,
					null);
		}
