package com.baoji.jiuguijiu.widgets.jazzviewpager;
	...
	protected void animateScroll(int position, float positionOffset) {
		if (mState != State.IDLE) {
			...
			ViewHelper.setRotationY(this, mState == State.GOING_RIGHT ? mRot
					: -mRot);
			ViewHelper.setPivotX(this, getMeasuredWidth());
			ViewHelper.setPivotY(this, getMeasuredHeight());
		}
	}
	...
	protected void animateTablet(View left, View right, float positionOffset) {
		if (mState != State.IDLE) {
			...
			if (right != null) {
				...
				ViewHelper.setPivotY(right, right.getMeasuredHeight());
