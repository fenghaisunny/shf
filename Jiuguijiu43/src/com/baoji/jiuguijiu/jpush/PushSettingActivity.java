...
public class PushSettingActivity extends InstrumentedActivity implements OnClickListener {
   ...
   @Override
	...
	private void setPushTime(){
		...
		if (startime > endtime) {
			Toast.makeText(PushSettingActivity.this, "å¼?§‹æ—¶é—´ä¸èƒ½å¤§äºç»“æŸæ—¶é—´", Toast.LENGTH_SHORT).show();
			return;
		}
		...
		mEditor.commit();
		Toast.makeText(PushSettingActivity.this, R.string.setting_su, Toast.LENGTH_SHORT).show();
	}
