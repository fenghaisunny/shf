package com.baoji.jiuguijiu.ui.base;
...
import com.baoji.jiuguijiu.task.AsyncCallable;
import com.baoji.jiuguijiu.task.Callback;
import com.baoji.jiuguijiu.task.EMobileTask;
import com.baoji.jiuguijiu.task.ProgressCallable;
import com.baoji.jiuguijiu.ui.ProductListTableItem;
...
public abstract class BaseActivity extends FragmentActivity {
	 ...
	 * @param pti
	 */
	protected void openActivity(Class<?> pClass, ProductListTableItem pti) {
		Intent intent = new Intent(this, pClass);
		if (pti != null) {
			intent.putExtra("proInfo", (Serializable) pti);;
		}
...
//獲得設備信息
 ...
 protected String getCountry() {
	...
	protected <T> void doAsync(final int pTitleResID, final int pMessageResID, final Callable<T> pCallable, final Callback<T> pCallback, final Callback<Exception> pExceptionCallback) {
		com.baoji.jiuguijiu.task.EMobileTask.doAsync(this, pTitleResID, pMessageResID, pCallable, pCallback, pExceptionCallback);
	}
	/**
